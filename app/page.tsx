...
export default function Home() {
  ...
  const handleAddTask = async () => {
    ...
    const success = await addTask({
      ...
      user_id: DEV_USER_ID, is_completed: false, habit_type: formData.habitType, due_date: formData.dueDate || null, target_days: formData.targetDays,
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-950 text-white overflow-hidden relative">
      ...
      /* viewMode が 'game' の時だけ表示される画面 */
        ...
        <div className="flex min-h-0 w-full flex-1 flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
